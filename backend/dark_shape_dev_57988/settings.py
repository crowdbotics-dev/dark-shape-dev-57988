"""
Django settings for dark_shape_dev_57988 project.
...
ROOT_URLCONF = 'dark_shape_dev_57988.urls'
...
WSGI_APPLICATION = 'dark_shape_dev_57988.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_shape_dev_57988 API",
    "DESCRIPTION": "API documentation for dark_shape_dev_57988 App",
    "VERSION": "v1",
}
